...
import org.apache.struts2.convention.ConventionUnknownHandler.Resource;
...
public class AppConfig {
    ...
    public SqlSessionFactoryBean sqlSessionFactory() throws Exception {
        ClassPathResource resource = new ClassPathResource("SqlMapConfig.xml");
    ...
    public MapperScannerConfigurer mapperScannerConfigurer() {
        ...
        mapperScannerConfigurer.setBasePackage("com.tpv.struts.mapper");
